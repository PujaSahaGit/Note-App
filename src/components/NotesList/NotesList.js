...
import { parseISO, formatDistanceToNow } from 'date-fns';
import { Link } from "react-router-dom";
import { removeNote, pinNote } from '../../features/notes/noteSlice'; // Import pinNote action
import { useDispatch } from 'react-redux';
              ...
              <div className='notes-item' key={note.noteId}>
                ...
                <div className='notes-item-btns flex align-center justify-between'>
                  <div>
                    ...
                    <button type="button" className='notes-item-btn' onClick={() => dispatch(pinNote(note.noteId))}>
                      {note.pinned ? <ImUndo2 /> : <ImPushpin />}
                      {/* {note.pinned ?  <ImPushpin /> : <ImUndo2 />} */}
                    </button>
